...
import top.rabbitbyte.nowblog.annotation.LoginRequired;
import top.rabbitbyte.nowblog.entity.User;
import top.rabbitbyte.nowblog.service.FollowService;
...
public class UserController {
    ...
    public String uploadHeader(MultipartFile headerImage, Model model) {
        ...
        if (created) {
            logger.atInfo().log("Folder '" + uploadPath + "' created successfully.");
        } else {
            logger.error("Error creating folder '" + uploadPath + "'.");
        }
    ...
    public  String  updatePassword(String oldPassword, String newPassword,String confirmPassword,Model model,HttpServletResponse response) {
        //获取用户id
        //验证旧密码是否正确
        //修改密码
        //修改加盐信息
