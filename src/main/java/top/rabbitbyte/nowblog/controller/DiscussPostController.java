...
import static top.rabbitbyte.nowblog.util.CommunityConstant.ENTITY_TYPE_COMMENT;
    ...
    public String getDiscussPost(@PathVariable("discussPostId") int discussPostId, Model model, Page page) {
        ...
        if (commentList != null) {
            for (Comment comment : commentList) {
                ...
                // 作者
                commentVo.put("user", userService.findUserById(String.valueOf(comment.getUserId())));
                ...
                if (replyList != null) {
                    for (Comment reply : replyList) {
                        ...
                        // 作者
                        replyVo.put("user", userService.findUserById(String.valueOf(reply.getUserId())));
                        // 回复目标
                        User target = reply.getTargetId() == 0 ? null : userService.findUserById(String.valueOf(reply.getTargetId()));
